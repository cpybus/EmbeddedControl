...
S:LLab6.getchar$c$1$39({1}SC:S),R,0,0,[]
S:LLab6.lcd_clear$NumBytes$1$77({1}SC:U),E,0,0
S:LLab6.lcd_clear$Cmd$1$77({2}DA2d,SC:U),E,0,0
S:LLab6.read_keypad$i$1$78({1}SC:U),R,0,0,[r7]
S:LLab6.read_keypad$Data$1$78({2}DA2d,SC:U),E,0,0
S:LLab6.kpd_input$mode$1$80({1}SC:S),R,0,0,[r7]
S:LLab6.kpd_input$sum$1$81({2}SI:U),R,0,0,[r5,r6]
S:LLab6.kpd_input$key$1$81({1}SC:S),R,0,0,[r3]
S:LLab6.kpd_input$i$1$81({1}SC:S),R,0,0,[]
S:LLab6.i2c_write_data$start_reg$1$97({1}SC:U),E,0,0
S:LLab6.i2c_write_data$buffer$1$97({3}DG,SC:U),E,0,0
S:LLab6.i2c_write_data$num_bytes$1$97({1}SC:U),E,0,0
S:LLab6.i2c_write_data$addr$1$97({1}SC:U),R,0,0,[r7]
S:LLab6.i2c_write_data$i$1$98({1}SC:U),R,0,0,[]
S:LLab6.i2c_read_data$start_reg$1$99({1}SC:U),E,0,0
S:LLab6.i2c_read_data$buffer$1$99({3}DG,SC:U),E,0,0
S:LLab6.i2c_read_data$num_bytes$1$99({1}SC:U),E,0,0
S:LLab6.i2c_read_data$addr$1$99({1}SC:U),R,0,0,[r7]
...
S:LLab6.main$error$1$114({2}SI:S),E,0,0
S:LLab6.main$prev_error$1$114({2}SI:S),E,0,0
S:LLab6.main$temp_motorpw_alg6$1$114({4}SL:S),E,0,0
S:LLab6.main$original_desired$1$114({2}SI:U),E,0,0
S:LLab6.main$desired$1$114({2}SI:U),E,0,0
S:LLab6.main$actual$1$114({2}SI:U),E,0,0
S:LLab6.main$kp$1$114({4}SF:S),E,0,0
S:LLab6.main$kd$1$114({2}SI:U),E,0,0
S:LLab6.main$range$1$114({2}SI:U),E,0,0
S:LLab6.main$batteryV$1$114({2}SI:U),E,0,0
S:LLab6.main$kpError$1$114({4}SL:S),E,0,0
S:LLab6.main$kdError$1$114({4}SL:S),R,0,0,[r4,r5,r6,r7]
S:LLab6.main$difference$1$114({4}SL:S),R,0,0,[]
S:LLab6.main$sloc0$1$0({2}SI:U),E,0,0
S:LLab6.ReadRanger$Data$1$120({2}DA2d,SC:U),E,0,0
S:LLab6.ReadCompass$Data$1$122({2}DA2d,SC:U),E,0,0
S:LLab6.getDesiredHeading$desiredH$1$125({2}SI:U),R,0,0,[r5,r6]
S:LLab6.getDesiredHeading$letter$1$125({1}SC:U),R,0,0,[r7]
S:LLab6.getIndividualPress$finalKey$1$138({1}SC:S),R,0,0,[r6]
S:LLab6.getIndividualPress$keypad$1$138({1}SC:S),R,0,0,[r7]
S:LLab6.getNumberFromKeypad$letter$1$142({1}SC:U),R,0,0,[r6]
S:LLab6.getNumberFromKeypad$data2$1$142({3}DA3d,SC:U),E,0,0
S:LLab6.getNumberFromKeypad$index$1$142({1}SC:U),R,0,0,[]
S:LLab6.getNumberFromKeypad$temp$1$142({2}SI:U),R,0,0,[]
...
S:FLab6$__str_3$0$0({25}DA25d,SC:S),D,0,0
S:FLab6$__str_4$0$0({35}DA35d,SC:S),D,0,0
S:FLab6$__str_5$0$0({31}DA31d,SC:S),D,0,0
S:FLab6$__str_6$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_7$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_8$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_9$0$0({10}DA10d,SC:S),D,0,0
S:FLab6$__str_10$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_11$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_12$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_13$0$0({24}DA24d,SC:S),D,0,0
S:FLab6$__str_14$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_15$0$0({21}DA21d,SC:S),D,0,0
S:FLab6$__str_16$0$0({22}DA22d,SC:S),D,0,0
